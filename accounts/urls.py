...
urlpatterns = [
    ...
    path('<int:id>/product_view/', views.product_view, name='product_view'),
    path('products_all/', views.products_all, name='products_all'),
    path('<int:id>/product/', views.products_edit, name='product_edit'),
    path('product/<int:id>/delete/', views.products_delete, name='product_delete'),
