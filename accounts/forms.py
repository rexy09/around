...
class BusinessDetailsForm(forms.ModelForm):
    ...
    longitude = forms.DecimalField(label='longitude', widget=forms.TextInput(attrs={'placeholder':'Pin your location','id':'info1',}))
    latitude = forms.DecimalField(label='latitude', widget=forms.TextInput(attrs={'placeholder':'Pin your location','id':'info2',}))
...
class ProductsForm(forms.ModelForm):
    ...
    details = forms.CharField(label='', widget=forms.Textarea(attrs={'placeholder':'Product details', 'rows':'3'}))
    price = forms.FloatField(label='Product price', widget=forms.NumberInput())
...
class GalleryImgForm(forms.ModelForm):
    # image = forms.FileField( widget=forms.FileInput(attrs={'multiple':''}))
    class Meta:
        model = Gallery
        fields = ['image', ]